...
class RegionLoss(nn.Module):
    ...
    def forward(self, output, target):
        ...
        # else:
            # loss_cls = self.class_scale * nn.CrossEntropyLoss(reduction='sum')(cls, tcls)
        loss = loss_x + loss_y + loss_w + loss_l + loss_conf + loss_Euler
        print('nGT %d, recall %d, proposals %d, loss: x %f, y %f, w %f, h %f, conf %f, Euler %f, total %f' % (nGT, nCorrect, nProposals, loss_x.data, loss_y.data, loss_w.data, loss_l.data, loss_conf.data, loss_Euler.data ,loss.data))
